...
class Output
  ...
  :climate_zone, :geometry_profile, :input_variables, :output_variables, :EUI, :EUI_units, :daylight_autonomy,
  :geo_coords
  ...
  def to_hash
    { 'user_id' => @user_id, 'os_model_id' => @os_model_id, 'sql_path'=>@sql_path, 'created_timestamp'=>@created_timestamp,'building_type'=>@building_type,'climate_zone'=>@climate_zone, 'geometry_profile'=>@geometry_profile, 'input_variables'=>@input_variables.to_hash,'output_variables'=>@output_variables.to_hash,
